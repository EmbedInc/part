...
module part_reflist;
define part_reflist_init;
define part_reflist_del;
define part_reflist_new;
define part_reflist_add_end;
%include 'part2.ins.pas';
{
********************************************************************************
*
*   Subroutine PART_REFLIST_INIT (LIST, MEM)
*
...
********************************************************************************
*
*   Subroutine PART_REFLIST_DEL (LIST)
*
...
********************************************************************************
*
*   Subroutine PART_REFLIST_NEW (LIST, PART_P)
*
...
********************************************************************************
*
*   Subroutine PART_REFLIST_ADD_END (LIST, PART_P)
*
